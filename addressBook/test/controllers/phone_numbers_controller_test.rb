...
class PhoneNumbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone_number" do
    assert_difference("PhoneNumber.count") do
      post phone_numbers_url, params: { phone_number: { comment: @phone_number.comment, firstName: @phone_number.firstName, lastName: @phone_number.lastName, middleName: @phone_number.middleName, number: @phone_number.number } }
    end
  ...
  test "should update phone_number" do
    patch phone_number_url(@phone_number), params: { phone_number: { comment: @phone_number.comment, firstName: @phone_number.firstName, lastName: @phone_number.lastName, middleName: @phone_number.middleName, number: @phone_number.number } }
