class EmailsController < ApplicationController
  ...
  def index
    @emails = Email.where(firstName: params[:first_name], middleName: params[:middle_name], lastName: params[:last_name])
  end
  ...
  private
    ...
    def email_params
      params.require(:email).permit(:firstName, :middleName, :lastName, :emailAddress, :comment)
    end
end
